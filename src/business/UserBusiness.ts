...
export class UserBusiness {
    ...
    public editUser = async (input: any) => {
        ...
        if (typeof idToEdit !== 'string') {
            throw new BadRequestError(
                'id a ser editado é obrigatório e deve ser string'
            );
        }
        ...
        if (id !== undefined) {
            ...
            if (id.length < 1) {
                throw new BadRequestError(
                    "'id' deve possuir pelo menos 1 caractere"
                );
            }
        }
        ...
        if (password !== undefined) {
            ...
            if (password.length < 4) {
                throw new BadRequestError(
                    "'password' deve possuir pelo menos 4 caracteres"
                );
            }
        }
    ...
    public deleteUser = async (input: any) => {
        ...
        if (typeof idToDelete !== 'string') {
            throw new BadRequestError(
                'id a ser deletado é obrigatório e deve ser string'
            );
        }
